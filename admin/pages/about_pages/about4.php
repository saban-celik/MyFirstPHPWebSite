...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (isset($_POST['submit'])) {
        ...
        $query = "INSERT INTO about4 (title, content) VALUES ('$title', '$content')";
        if ($conn->query($query)) {
    ...
    if (isset($_POST['update'])) {
        ...
        $query = "UPDATE about4 SET title = '$title', content = '$content' WHERE id = $id";
        if ($conn->query($query)) {
    ...
    if (isset($_POST['delete'])) {
        ...
        $query = "DELETE FROM about4 WHERE id = $id";
        if ($conn->query($query)) {
...
$query = "SELECT * FROM about4";
$result = $conn->query($query);
if (!$result) {
    die("Veritabanı hatası: " . $conn->error);
}
$about4Contents = $result->fetch_all(MYSQLI_ASSOC);
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>About4 Content Management</title>
    <link href="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css" rel="stylesheet">
    <link href="./css/home.css" rel="stylesheet">
</head>
<body>
    <div class="container">
        <h2 class="my-4">Başlık-İçerik Yönetimi</h2>
